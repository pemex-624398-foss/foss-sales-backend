...
# Build Docker Image
cp global.json Foss.Sales.Backend.Api/bin/Release/net6.0/publish/
docker build -t foss-sales-backend Foss.Sales.Backend.Api
...
# Run the Application
docker run -d --network foss --name foss-sales-api -p 5555:5000 ghcr.io/pemex-624398-foss/foss-sales-backend:624398-latest
...
PAT - 7 days
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