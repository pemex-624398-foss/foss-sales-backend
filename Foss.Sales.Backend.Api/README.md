...
docker run -d --restart unless-stopped --network foss --name foss-sales-api -p 5555:5000 ghcr.io/pemex-624398-foss/foss-sales-backend:624398-latest
...
docker run -d \
  ...
  -e REPO_PASS=$(cat github-pat.txt) \
